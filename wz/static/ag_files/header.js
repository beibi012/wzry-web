...
var pvpHeader = (function () {
	...
	util.addHeaderHTML = function () {
		...
		headerHTML += '          <a href="//pvp.qq.com/" target="_blank" title="官网首页" onclick="PTTSendClick(\'link\',\'home\',\'官网首页\');">官网首页<em>HOME</em></a>';
		headerHTML += '        </li>';
		headerHTML += '        <li>';
		...
		headerHTML += '        </li>';
		headerHTML += '        <li>';
		headerHTML += '          <a href="/match/center.shtml?ADTAG=pvp.index.nav.matchcenter" target="_blank" title="赛事中心" onclick="PTTSendClick(\'link\',\'match\',\'赛事中心\');">赛事中心<em>MATCH</em></a>';
		headerHTML += '        </li>';
		headerHTML += '        <li>';
		headerHTML += '          <a href="/cp/a20171023pvppc/" target="_blank" title="商城/合作" onclick="PTTSendClick(\'link\',\'CULTURE\',\'百态王者\');">百态王者<em>CULTURE</em></a>';
		headerHTML += '        </li>';
		headerHTML += '        <li>';
		...
		headerHTML += '             <a href="/coming/v2/" target="_blank" title="爆料站" onclick="PTTSendClick(\'link\',\'data_coming\',\'爆料站\');"><i class="icon-fans"></i>爆料站</a>';
		...
		headerHTML += '             <a href="/cp/a20180808wzsj/index.htm" target="_blank" title="王者视角" onclick="PTTSendClick(\'link\',\'a20180808wzsj\',\'王者视角\');">王者视角</a>';
		headerHTML += '             <a href="/author/" target="_blank" title="作者入驻" onclick="PTTSendClick(\'link\',\'author\',\'作者入驻\');">作者入驻</a>';
		headerHTML += '             <a href="/mcn/" target="_blank" title="媒体入驻" onclick="PTTSendClick(\'link\',\'mcn\',\'媒体入驻\');">媒体入驻</a>';
		headerHTML += '          </li>';
		headerHTML += '          <li class="down-nav">';
		headerHTML += '            <a href="/match/kpl/index.shtml" target="_blank" title="KPL职业联赛" onclick="PTTSendClick(\'link\',\'match_KPL\',\'KPL\');"><i class="icon-fans"></i>KPL</a>';
		headerHTML += '             <a href="/match/kcc.shtml" target="_blank" title="冠军杯" onclick="PTTSendClick(\'link\',\'match_kcc\',\'kcc\');">冠军杯</a>';
		headerHTML += '            <a href="/cp/a20181017krkpl/index.html" target="_blank" title="KRKPL联赛" onclick="PTTSendClick(\'link\',\'match_KRKPL\',\'KRKPL\');"><i class="icon-hot"></i>KRKPL</a>';
		// headerHTML +='             <a href="/match/krkpl/" target="_blank" title="KPL韩国职业联赛" onclick="PTTSendClick(\'link\',\'match_KRKPL\',\'KRKPL\');">KRKPL</a>';
		headerHTML += '             <a href="/cp/a20180906gxls/index.shtml" target="_blank" title="王者高校联赛" onclick="PTTSendClick(\'link\',\'match_gaoxiao\',\'王者高校联赛\');">高校赛</a>';
		headerHTML += '             <a href="/cp/a20180822citylg/index.shtml" target="_blank" title="王者荣耀城市赛" onclick="PTTSendClick(\'link\',\'match_city\',\'王者荣耀城市赛\');">城市赛</a>';
		...
		headerHTML += '             <a href="/match/quanmin/index.html#/" target="_blank" title="全民赛" onclick="PTTSendClick(\'link\',\'match_KCC\',\'quanmin\');">全民赛</a>';
		headerHTML += '             <a href="//datamore.qq.com/project/wzmatch/dist/index.html" target="_blank" title="赛事数据" onclick="PTTSendClick(\'link\',\'match_datamore\',\'赛事数据\');"><i class="icon-fans"></i>赛事数据</a>';
		...
		headerHTML += '          </li>';
		headerHTML += '          <li class="down-nav">';
		headerHTML += '             <a href="/culture/inherit.html" target="_blank" title="荣耀·传承" onclick="PTTSendClick(\'link\',\'culture\',\'荣耀·传承\');">荣耀·传承</a>';
		...
		headerHTML += '             <a href="/cp/a20170726hsbbspc/index.html" target="_blank" title="健康系统" onclick="PTTSendClick(\'link\',\'player_healthy\',\'健康系统\');"><i class="icon-health"></i>健康系统</a>';
		headerHTML += '             <a href="/cp/a20181105talk/" target="_blank" title="狄仁杰护卫站" onclick="PTTSendClick(\'link\',\'player_drj\',\'狄仁杰护卫站\');"><i class="icon-fans"></i>狄仁杰护卫站</a>';
